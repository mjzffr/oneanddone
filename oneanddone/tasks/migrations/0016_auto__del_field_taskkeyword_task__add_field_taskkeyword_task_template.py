...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'TaskKeyword.task'
        db.delete_column('tasks_taskkeyword', 'task_id')

        # Adding field 'TaskKeyword.task_template'
        db.add_column('tasks_taskkeyword', 'task_template',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='keyword_set', to=orm['tasks.TaskTemplate']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'TaskKeyword.task'
        db.add_column('tasks_taskkeyword', 'task',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='keyword_set', to=orm['tasks.TaskTemplate']),
                      keep_default=False)
    ...
    models = {
        ...
        'tasks.taskkeyword': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'task_backup': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tasks.TaskTemplate']"}),
            'task_template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'keyword_set'", 'to': "orm['tasks.TaskTemplate']"})
        },
        'tasks.taskproject': {
