...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Task.task_template'
        db.add_column('tasks_task', 'task_template',
                      self.gf('django.db.models.fields.related.OneToOneField')(to=orm['tasks.TaskTemplate'], unique=True, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Task.task_template'
        db.delete_column('tasks_task', 'task_template_id')
